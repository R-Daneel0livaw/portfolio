      ...
      <div>
        ...
        <section className={styles.sectionSpacer}>
          ...
          <p className={styles.sectionContent}>
            ...
            minor in Mathematics, from the esteemed SUNY Brockport. With nearly
            15 years of professional experience, my journey has been shaped by
        ...
        <section className={styles.sectionSpacer}>
          ...
          <p className={styles.sectionContent}>
            ...
            delving into new programming languages, I find joy in the continuous
        ...
        <section className={styles.sectionSpacer}>
          ...
          <p className={styles.sectionContent}>
            ...
            Logic, and Robotics are subjects that captivate my curiosity, and
            I'm always eager to delve into their depths.
          </p>
        </section>
      </div>
