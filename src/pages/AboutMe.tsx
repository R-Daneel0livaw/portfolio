...
export default function AboutMe() {
  return (
    <section id="about">
      ...
      <section id="tech-enthusiast-and-lifelong-learner">
        <h2>Tech Enthusiast and Lifelong Learner</h2>
        <p>
      ...
      <section id="freelance-web-development">
      ...
      <section id="hobbies">
        <h2>Hobbies: A Balanced Blend</h2>
        <p>
